# This file generates the "associations" fact table from our source data.
...
dest_table_name = 'fact_associations'
...
source_data = pd.read_sql_table('associations',con=engine)

# Pushing the dataframe to our relational schema with correct datatypes
source_data.to_sql(name=dest_table_name,schema=destination_schema,con=engine, if_exists='replace', index=False, dtype=ttypes['associations'])
